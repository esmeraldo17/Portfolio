    ...
    <div id='about' className='ml-[220px] bg-cyan-500 flex flex-row p-[50px] gap-x-5 items-center justify-center'>
      <div className='flex flex-col '>
        ...
        {/* <span className='font-semibold'></span> */}
          ...
          com paixão por criar soluções inovadoras e cativantes. Com 
          <span className='font-semibold'> um ano e dois meses de experiência como estudante e em projetos freelance.</span>
          <br/>
          ...
          e mergulhei em várias tecnologias e frameworks populares como 
          <span className='font-semibold'> React, Next e Node.js. </span>
          Domino o desenvolvimento 
      ...
      <Image src={image}  alt='thumb' className='rounded-tl-lg rounded-tr-md rounded-br-lg rounded-bl-sm w-[30%] opacity-80'></Image>
    </div>
  );
};
