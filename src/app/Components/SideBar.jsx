...
const SideBar = () => {
  return (
    <nav
      className='flex flex-col items-center justify-center w-[20%] h-[100vh] bg-cyan-800 rounded-r-lg shadow-xl shadow-cyan-600'
    >
      ...
      <div className='flex '>
        <Link href='https://github.com/esmeraldo17' target='_blank'>
          <svg className="w-6 h-6 text-gray-800 dark:text-white m-5 mt-7" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <Link href='https://www.linkedin.com/in/esmeraldo-alberto/' target='_blank'>
          <svg className="w-6 h-6 text-gray-800 dark:text-white m-5 mt-7" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 15">
